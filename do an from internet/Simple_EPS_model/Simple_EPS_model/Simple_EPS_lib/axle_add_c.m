    function axle_add_c(blk,blk2,sgn,pos)
    ...
    if strcmp('CP',blk)
      ...
      if ck ==0 && sgn == '+'
           ...
           elseif pos =='z'
               set_param([gcb '/' blk2],'MaskValueString','RigidTransform|StandardAxis|mm|+Z|lg/2|[0 0 0]|0|m|0|m|0|deg|None|deg|+Z|0|[0 0 1]|+X|+Y|+Y|+Z|simmechanics.library.frames_transforms.rigid_transform');
