    function axle_add_el(blk,blk2,sgn,pos)
    ...
    if strcmp('CP',blk)
      ...
      if ck ==0 && sgn == '+'
           ...
           if pos =='x'
               set_param([gcb '/' blk2],'MaskValueString','RigidTransform|StandardAxis|mm|+X|x|[0 0 0]|0|m|0|m|0|deg|None|deg|+Z|0|[0 0 1]|+X|+Y|+Y|+Z|simmechanics.library.frames_transforms.rigid_transform');
           ...
           elseif pos =='y'
               set_param([gcb '/' blk2],'MaskValueString','RigidTransform|StandardAxis|mm|+Y|y|[0 0 0]|0|m|0|m|0|deg|None|deg|+Z|0|[0 0 1]|+X|+Y|+Y|+Z|simmechanics.library.frames_transforms.rigid_transform');
           ...
           elseif pos =='z'
               set_param([gcb '/' blk2],'MaskValueString','RigidTransform|StandardAxis|mm|+Z|z|[0 0 0]|0|m|0|m|0|deg|None|deg|+Z|0|[0 0 1]|+X|+Y|+Y|+Z|simmechanics.library.frames_transforms.rigid_transform');
